...
export const COMMUNITY_STUBS: StubEntry[] = [
  ...
  { type: "route", path: "src/app/api/stripe/cancel/route.ts", methods: ["POST"] },
  ...
  { type: "route", path: "src/app/api/admin/backups/route.ts", methods: ["GET"] },
  { type: "route", path: "src/app/api/admin/backups/[id]/route.ts", methods: ["DELETE"] },
  ...
  { type: "page", path: "src/app/(admin)/admin/backups/page.tsx" },
